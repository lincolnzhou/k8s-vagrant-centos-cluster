...
sysctl -p
				...
				# set hostname
cat >> /etc/hosts <<EOF
172.17.8.101 kube-node1
172.17.8.102 kube-node2
172.17.8.103 kube-node3	
EOF
				# set nameserver
				echo 'set nameserver'
